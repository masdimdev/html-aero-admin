...
$.extend(_ext.type.order,{"date-pre":function(d){return Date.parse(d)||-Infinity;},"html-pre":function(a){return _empty(a)?'':a.replace?a.replace(/<.*?>/g,"").toLowerCase():a+'';},"string-pre":function(a){// This is a little complex, but faster than always calling toString,
